// A simple C program to practice using the calloc() function for memory allocation
...
int main(void) 
{
    ...
    scanf("%d", &n);
    // while malloc() allocates memory and leaves it uninitialized, calloc() allocates memory and initializes all bits to zero
    ptr = (int *) callo(n, sizeof(int)); // Allocating memory 
