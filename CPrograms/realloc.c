// A simple C program to practice using the realloc() function for memory allocation
...
int main(void) 
{
    ...
    printf("I feel you can do better than that. How many more integers would you like?\n> ");
    scanf("%d", &k);
    n+=k;
    ptr = realloc(ptr, n * sizeof(int)); //realloac simply reassigns the allocated memory
